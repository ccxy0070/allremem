package cn.ar.allremem.common.exceptions;

/**
 * @Title BizException.java<br/>
 * @Description 业务异常基类，所有业务异常都必须继承于此异常 <br/>
 * @Package: cn.ar.allremem.common.exceptions <br/>
 * @version ver1.0<br/>
 * @since JDK 1.8<br/>
 * @author zhangxy<br/>
 * @date: 2018年1月10日 上午9:26:16 <br/>
 */
